...
namespace SocialOffice.Migrations
{
    /// <inheritdoc />
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppDirectMessage", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppDirectMessage_AbpUsers_FromUserId",
                        column: x => x.FromUserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AppDirectMessage_AbpUsers_ToUserId",
                        column: x => x.ToUserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppFriendship_AbpUsers_ReceiverId",
                        column: x => x.ReceiverId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AppFriendship_AbpUsers_RequestorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppPost_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppUserProfile_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppImage_AppPost_PostId",
                        column: x => x.PostId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppDirectMessage_FromUserId",
                table: "AppDirectMessage",
                column: "FromUserId");

            migrationBuilder.CreateIndex(
                name: "IX_AppDirectMessage_ToUserId",
                table: "AppDirectMessage",
                column: "ToUserId");

            migrationBuilder.CreateIndex(
                name: "IX_AppFriendship_ReceiverId",
                table: "AppFriendship",
                column: "ReceiverId");

            migrationBuilder.CreateIndex(
                name: "IX_AppFriendship_RequestorId",
                table: "AppFriendship",
                column: "RequestorId");

            migrationBuilder.CreateIndex(
                name: "IX_AppImage_PostId",
                table: "AppImage",
                column: "PostId");

            migrationBuilder.CreateIndex(
                name: "IX_AppPost_UserId",
                table: "AppPost",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_AppUserProfile_UserId",
